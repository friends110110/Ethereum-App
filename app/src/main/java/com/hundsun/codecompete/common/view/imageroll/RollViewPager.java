package com.hundsun.codecompete.common.view.imageroll;
...
import com.hundsun.codecompete.utils.ViewUtils;
...
//        LinearLayout dotsLl= (LinearLayout) findViewById(R.id.dots_ll);
    ...
    public void setData(Context context, LinearLayout dotsLl,int resImages[],
//                        int dot_focus_resId, int dot_normal_resId,
                        OnPagerClickCallback onPagerClickCallback){
        this.context = context;
        this.dots = initDot(dotsLl,resImages.length);
//        this.dot_focus_resId = R.mipmap.dot_focus_resId;
//        this.dot_normal_resId = R.mipmap.dot_normal_resId;
        this.isShowResImage=true;
        this.resImageIds=resImages;
        this.dot_focus_resId = R.mipmap.dot_focus;
        this.dot_normal_resId = R.mipmap.dot_normal;
        this.onPagerClickCallback = onPagerClickCallback;
        viewPagerTask = new ViewPagerTask();
//        bitmapUtils = new BitmapUtils(context);
//        bitmapUtils.configDefaultBitmapConfig(Bitmap.Config.RGB_565);
...
//            imageView.setBackgroundResource(R.mipmap.scene1);
